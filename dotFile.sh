#!/bin/bash
sudo apt update && sudo apt upgrade && sudo apt install i3-wm polybar nvim firefox  brightnessctl git
git clone https://github.com/adi1090x/polybar-themes.git && cd polybar-themes && chmod +x setup.sh && ./setup.sh
